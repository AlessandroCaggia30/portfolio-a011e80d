"""Build AI walkthrough plot for Ex 5.10b — estimated SE of the sample mean
of Company$Profitability (n = 668, s_x = 365.3158, xbar = 930.27), the
point estimate, and why we cannot say how far that specific xbar lies from
the unknown mu_X. Three panels: (1) the sample with xbar and s_x; (2) the
sampling distribution of Xbar centred on the UNKNOWN mu (illustrated with
several plausible mu values); (3) many resampled xbars from one plausible
mu, showing that SE quantifies typical spread, not the deviation of OUR
specific xbar."""
import os, sys
...
OUT = "/Users/Alessandro/Repos/portfolio-a011e80d/apps/mindnotes/statistics/images/ex5/ex5_10b_ai.png"
...
# Affine rescale so empirical mean == xbar and sd == s_x (cosmetic only)
...
#   Show three plausible mu's; for each, draw N(mu, SE^2). The point: the
#   centre is unknown, so we cannot place xbar on the x-axis relative to mu.
# ====================================================================
...
# ====================================================================
# RIGHT — many resample xbars from ONE plausible mu, show SE = typical
#         spread, but for THIS sample only one xbar exists
# ====================================================================
mu_plot   = 930.0
B         = 2000
